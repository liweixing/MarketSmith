...
/**
 * 在ScrollView中使用之后能够自适应大小
 * 
 * */
public class PullToRefreshListViewForScrollView extends
	...
	public PullToRefreshListViewForScrollView(Context context, Mode mode) {
		super(context, mode);
	}
	...
	final class InternalListViewSDK9 extends InternalListView {
		...
		protected boolean overScrollBy(int deltaX, int deltaY, int scrollX,
			...
			OverscrollHelper.overScrollBy(
					PullToRefreshListViewForScrollView.this, deltaX, scrollX,
	...
	protected class InternalListView extends ListView implements
		...
		public void setEmptyView(View emptyView) {
			PullToRefreshListViewForScrollView.this.setEmptyView(emptyView);
		}
